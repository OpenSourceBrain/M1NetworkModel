...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Izhi2007b /u/salvadord/Documents/ISB/Models/M1NetworkModel/sim/x86_64/izhi2007b.mod\n");
...
_deriv1_advance = 0;
 if(error){fprintf(stderr,"at line 86 in file izhi2007b.mod:\n  SOLVE states METHOD derivimplicit  : cnexp\n"); nrn_complain(_p); abort_run(error);}
